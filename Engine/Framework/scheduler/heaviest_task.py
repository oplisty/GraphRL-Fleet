...
class HeaviestTaskScheduler(SchedulerBase):
    """Greedy baseline: choose highest-weight feasible task first."""
    ...
    def select_actions(self, env) -> list[tuple[int, int]]:
        ...
        remaining_tasks.sort(key=lambda t: t.weight, reverse=True)
